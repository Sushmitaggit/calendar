    ...
    private fun loadCalendar() {
        ...
        val date = DatePickerDialog(this,
                DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                    ...
                    if (y == 0) {
                        tvYear.text = " No. of years worked : $m month "
                    } else if (m == 0) {
                        tvYear.text = " No. of years worked :  $y year "
                    } else {
                        tvYear.text = " No. of years worked : $y year $m month "
                    }
                },
                year,
                month,
    ...
    private fun loadCalender() {
        ...
        val date = DatePickerDialog(this,
                DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                    ...
                    if (y == 0) {
                        tvAge.text = " Your Age is : $m month "
                    } else if (m == 0) {
                        tvAge.text = " Your Age is :  $y year "
                    } else {
                        tvAge.text = " Your Age is : $y year $m month "
                    }
                },
                year,
                month,
